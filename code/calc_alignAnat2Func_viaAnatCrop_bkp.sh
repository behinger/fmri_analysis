...
#flirt -in './func/'$bids'_task-'$task'_desc-occipitalcropMeanBias_bold.nii' -ref './anat/'$bids'_desc-anatomical_T1w.nii.gz' -omat './coreg/'$bids'_from-FUNCCROPPED_to-ANATCROPPED.mat' -out './func/'$bids'_task-'$TASK'_desc-occipitalcropMeanBias_space-ANATCROPPED_bold.nii' -bins 600 -cost corratio  -dof 6 -interp trilinear -searchrx -10 10 -searchry -10 10 -searchrz -10 10
...
flirt -in './anat/'$bids'_desc-anatomical_T1w.nii' -ref './anat/'$bids'_desc-anatomical_T1w.nii' \
...
#flirt -in './anat/'$bids'_desc-occipitalcrop_space-ANAT_T1w.nii' -init './coreg/'$bids'_from-ANAT_to-FUNCCROPPED.mat' \
#-ref './func/'$bids'_task-'$task'_desc-occipitalcropMeanBias_bold.nii' -out './anat/'$bids'_desc-anatomical_space-FUNCCROPPED_T1w.nii' -applyxfm
